...
function Sidebar({
  ...
  const themeClass = variant === 'white' ? 'sidebar-theme--white' : 'sidebar-theme--brand';
  ...
  return (
    <div className="min-w-fit">
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`sidebar-theme ${themeClass} flex lg:flex! flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-[100dvh] overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:w-64! shrink-0 p-4 transition-all duration-200 ease-in-out ${sidebarOpen ? "translate-x-0" : "-translate-x-64"} ${variant === 'v2' ? 'border-r' : 'rounded-r-2xl shadow-xs'}`}
      >
        {/* Sidebar header */}
