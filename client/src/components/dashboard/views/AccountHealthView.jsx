      ...
      <div className="ticket-modal" onClick={(event) => event.stopPropagation()}>
        ...
        <div className="ticket-detail-grid">
          <div className="ticket-detail-card">
            <span className="ticket-detail-card__label">Zendesk Account ID</span>
            <strong className="ticket-detail-card__value">{ticket.zendesk_account_id || 'Not available'}</strong>
          </div>
          <div className="ticket-detail-card">
...
export default function AccountHealthView() {
  ...
  const ticketsQuery = useQuery({
    queryKey: ['account-health-tickets', API_BASE, userId],
    queryFn: async () => {
            ...
            <article key={ticket.id} className="ticket-card">
              ...
              <div className="ticket-card__meta">
                <div className="ticket-card__meta-item">
                  <span>Zendesk Account</span>
                  <strong>{ticket.zendesk_account_id || 'N/A'}</strong>
                </div>
                <div className="ticket-card__meta-item">
                  <span>Receiver</span>
