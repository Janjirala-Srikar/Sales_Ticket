...
const LOGO_SVGS = {
  zendesk: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
    <defs>
      <clipPath id="circle-clip-z">
        <circle cx="100" cy="100" r="96"/>
      </clipPath>
    </defs>
    <circle cx="100" cy="100" r="96" fill="#1560A0"/>
    <circle cx="100" cy="100" r="96" fill="url(#vignette-z)" opacity="0.3"/>
    <defs>
      <radialGradient id="vignette-z" cx="50%" cy="30%" r="70%">
        <stop offset="0%" stop-color="white" stop-opacity="0.15"/>
        <stop offset="100%" stop-color="black" stop-opacity="0.4"/>
      </radialGradient>
    </defs>
    <g clip-path="url(#circle-clip-z)">
      <text x="100" y="118" font-family="Arial Black,sans-serif" font-size="110" font-weight="900" fill="white" fill-opacity="0.95" text-anchor="middle">Z</text>
    </g>
    <circle cx="100" cy="100" r="96" fill="none" stroke="rgba(255,255,255,0.12)" stroke-width="1.5"/>
  </svg>`,

  intercom: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
    <defs>
      <clipPath id="circle-clip-i">
        <circle cx="100" cy="100" r="96"/>
      </clipPath>
      <radialGradient id="vignette-i" cx="50%" cy="30%" r="70%">
        <stop offset="0%" stop-color="white" stop-opacity="0.12"/>
        <stop offset="100%" stop-color="black" stop-opacity="0.35"/>
      </radialGradient>
    </defs>
    <circle cx="100" cy="100" r="96" fill="#1278CC"/>
    <circle cx="100" cy="100" r="96" fill="url(#vignette-i)" opacity="0.4"/>
    <g clip-path="url(#circle-clip-i)">
      <rect x="44" y="54" width="17" height="66" rx="8.5" fill="white" fill-opacity="0.92"/>
      <rect x="73" y="42" width="17" height="78" rx="8.5" fill="white" fill-opacity="0.92"/>
      <rect x="102" y="48" width="17" height="72" rx="8.5" fill="white" fill-opacity="0.92"/>
      <rect x="131" y="60" width="17" height="56" rx="8.5" fill="white" fill-opacity="0.92"/>
    </g>
    <circle cx="100" cy="100" r="96" fill="none" stroke="rgba(255,255,255,0.12)" stroke-width="1.5"/>
  </svg>`,

  salesforce: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
    <defs>
      <clipPath id="circle-clip-sf">
        <circle cx="100" cy="100" r="96"/>
      </clipPath>
      <radialGradient id="vignette-sf" cx="50%" cy="30%" r="70%">
        <stop offset="0%" stop-color="white" stop-opacity="0.12"/>
        <stop offset="100%" stop-color="black" stop-opacity="0.38"/>
      </radialGradient>
    </defs>
    <circle cx="100" cy="100" r="96" fill="#0088C2"/>
    <circle cx="100" cy="100" r="96" fill="url(#vignette-sf)" opacity="0.4"/>
    <g clip-path="url(#circle-clip-sf)">
      <ellipse cx="100" cy="88" rx="46" ry="34" fill="white" fill-opacity="0.95"/>
      <ellipse cx="64" cy="102" rx="20" ry="15" fill="white" fill-opacity="0.95"/>
      <ellipse cx="136" cy="99" rx="23" ry="17" fill="white" fill-opacity="0.95"/>
    </g>
    <circle cx="100" cy="100" r="96" fill="none" stroke="rgba(255,255,255,0.12)" stroke-width="1.5"/>
  </svg>`,

  hubspot: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
    <defs>
      <clipPath id="circle-clip-hs">
        <circle cx="100" cy="100" r="96"/>
      </clipPath>
      <radialGradient id="vignette-hs" cx="50%" cy="30%" r="70%">
        <stop offset="0%" stop-color="white" stop-opacity="0.12"/>
        <stop offset="100%" stop-color="black" stop-opacity="0.38"/>
      </radialGradient>
    </defs>
    <circle cx="100" cy="100" r="96" fill="#E8623A"/>
    <circle cx="100" cy="100" r="96" fill="url(#vignette-hs)" opacity="0.4"/>
    <g clip-path="url(#circle-clip-hs)">
      <circle cx="126" cy="78" r="19" fill="white" fill-opacity="0.95"/>
      <circle cx="126" cy="78" r="10" fill="#E8623A"/>
      <line x1="107" y1="78" x2="72" y2="78" stroke="white" stroke-opacity="0.95" stroke-width="11" stroke-linecap="round"/>
      <line x1="72" y1="78" x2="72" y2="124" stroke="white" stroke-opacity="0.95" stroke-width="11" stroke-linecap="round"/>
      <line x1="72" y1="124" x2="100" y2="124" stroke="white" stroke-opacity="0.95" stroke-width="11" stroke-linecap="round"/>
    </g>
    <circle cx="100" cy="100" r="96" fill="none" stroke="rgba(255,255,255,0.12)" stroke-width="1.5"/>
  </svg>`,

  slack: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
    <defs>
      <clipPath id="circle-clip-sl">
        <circle cx="100" cy="100" r="96"/>
      </clipPath>
      <radialGradient id="vignette-sl" cx="50%" cy="30%" r="70%">
        <stop offset="0%" stop-color="white" stop-opacity="0.10"/>
        <stop offset="100%" stop-color="black" stop-opacity="0.42"/>
      </radialGradient>
    </defs>
    <circle cx="100" cy="100" r="96" fill="#3C1040"/>
    <circle cx="100" cy="100" r="96" fill="url(#vignette-sl)" opacity="0.4"/>
    <g clip-path="url(#circle-clip-sl)">
      <rect x="58" y="54" width="19" height="48" rx="9.5" fill="#E01E5A"/>
      <rect x="58" y="112" width="19" height="19" rx="9.5" fill="#E01E5A"/>
      <rect x="88" y="72" width="19" height="48" rx="9.5" fill="#36C5F0"/>
      <rect x="88" y="54" width="19" height="10" rx="5" fill="#36C5F0"/>
      <rect x="118" y="72" width="19" height="48" rx="9.5" fill="#2EB67D"/>
      <rect x="118" y="130" width="19" height="10" rx="5" fill="#2EB67D"/>
      <rect x="58" y="88" width="49" height="19" rx="9.5" fill="#ECB22E"/>
    </g>
    <circle cx="100" cy="100" r="96" fill="none" stroke="rgba(255,255,255,0.12)" stroke-width="1.5"/>
  </svg>`,
};
